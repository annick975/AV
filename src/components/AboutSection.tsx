  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Rwanda Community Image */}
        <div className="mb-16 relative rounded-2xl overflow-hidden shadow-2xl">
          <Image
            src="/images/rwanda-community.svg"
            alt="Rural Rwanda community powered by AirVolt technology"
            width={1200}
            height={600}
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="p-8">
            ...
            <p className="text-gray-600 text-center mb-8 max-w-2xl mx-auto">
              See how our innovative graphene oxide technology transforms humidity into clean electricity
            </p>
          </div>
          <Image
            src="/images/technology-diagram.svg"
            alt="AirVolt technology components and process diagram"
            width={800}
            height={600}
            className="w-full h-auto"
          />
